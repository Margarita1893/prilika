            ...
            <div class="mt-4">
                <x-jet-label for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            {!! __('De acuerdo con: terminos de servicio y politica de privacidad', [
                            'terminos_de_servicio' => '<a target="_blank" href="'.route('terms.show').'"
                                class="underline text-sm text-gray-600 hover:text-gray-900">'.__('Terms of
                                Service').'</a>',
                            'politica_privacidad' => '<a target="_blank" href="'.route('policy.show').'"
